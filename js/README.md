...
- **Observation planner** — browse the Messier catalog, the full ~227k-object
  deep-sky database, or the Solar System (the Sun, planets, and Pluto),
  filtered by date/location, type, magnitude, "visible now," peak altitude,
  and time-at-apex window, paginated 20 at a time.
